...
export default function PostItem({ post }: { post: Post }) {
    ...
    return (
      <Link href={`/post/${post.id}`} className="block group">
        <Card className="p-4 mb-4 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover:-translate-x-0.5 hover:shadow-primary/20 border-0">
          <div className="flex gap-4">
            ...
            <div className="flex-shrink-0">
              {post.thumbnail ? (
                ...
                <div className="w-20 h-20 md:w-24 md:h-24 lg:w-32 lg:h-32 bg-background shadow-sm rounded-md flex items-center justify-center">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-lg font-semibold text-card-foreground transition-colors duration-200 line-clamp-1">
                {post.title}
              </h2>
